        ...
        <section className={styles.section}>
          ...
          <div className={styles.gallery}>
            <figure className={styles.galleryCard}>
              <img src={withBasePath('/images/projects/p3/11.jpg')} alt="研究论文成果图1" loading="eager" fetchPriority="high" />
              <figcaption className={styles.caption}>论文成果展示：《社会工作与管理》</figcaption>
            </figure>
            <figure className={styles.galleryCard}>
              <img src={withBasePath('/images/projects/p3/12.jpg')} alt="研究成果图2" loading="eager" fetchPriority="high" />
              <figcaption className={styles.caption}>理论文章刊载版面</figcaption>
            </figure>
            <figure className={styles.galleryCard}>
              <img src={withBasePath('/images/projects/p3/13.jpg')} alt="研究成果图3" loading="eager" fetchPriority="high" />
              <figcaption className={styles.caption}>新质生产力主题研究文章</figcaption>
            </figure>
            <figure className={styles.galleryCard}>
              <img src={withBasePath('/images/projects/p3/14.jpg')} alt="学术会议参会图1" loading="eager" fetchPriority="high" />
              <figcaption className={styles.caption}>学术会议研讨与交流现场</figcaption>
            </figure>
            <figure className={styles.galleryCard}>
              <img src={withBasePath('/images/projects/p3/15.jpg')} alt="学术会议参会图2" loading="eager" fetchPriority="high" />
              <figcaption className={styles.caption}>会议报告与主题发言场景</figcaption>
            </figure>
            <figure className={styles.galleryCard}>
              <img src={withBasePath('/images/projects/p3/16.jpg')} alt="学术会议参会图3" loading="eager" fetchPriority="high" />
